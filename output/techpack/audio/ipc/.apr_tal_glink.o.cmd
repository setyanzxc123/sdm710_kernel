cmd_techpack/audio/ipc/apr_tal_glink.o := clang -Wp,-MD,techpack/audio/ipc/.apr_tal_glink.o.d -nostdinc -isystem /home/setyan/Downloads/SDClang-10/lib/clang/10.0.11/include -I../arch/arm64/include -I./arch/arm64/include/generated/uapi -I./arch/arm64/include/generated  -I../include -I./include -I../arch/arm64/include/uapi -I../include/uapi -I./include/generated/uapi -include ../include/linux/kconfig.h -I../techpack/audio/include/uapi -I../techpack/audio/include -include ../techpack/audio/config/sdm710autoconf.h -I../techpack/audio/ipc -Itechpack/audio/ipc -D__KERNEL__ -DVENDOR_EDIT -Qunused-arguments -mlittle-endian -Qunused-arguments -DANI_LITTLE_BYTE_ENDIAN -DANI_LITTLE_BIT_ENDIAN -DDOT11F_LITTLE_ENDIAN_HOST -DANI_COMPILER_TYPE_GCC -DANI_OS_TYPE_ANDROID=6 -DPTT_SOCK_SVC_ENABLE -Wall -D__linux__ -DMULTI_IF_NAME=\"\" -DBUILD_TIMESTAMP=\"2023-06-13T10:20:45Z\" -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -Werror-implicit-function-declaration -Wno-format-security -std=gnu89 -DVENDOR_EDIT -Wno-unused-variable -Wno-format-invalid-specifier -Wno-gnu -Wno-address-of-packed-member -Wno-duplicate-decl-specifier -Wno-undefined-optimized -Wno-tautological-constant-out-of-range-compare -Wno-sometimes-uninitialized -Wno-asm-operand-widths -Wno-initializer-overrides -fno-builtin -Wno-tautological-compare -mno-global-merge --target=aarch64-linux-gnu --prefix=/usr/bin/aarch64-linux-gnu- --gcc-toolchain=/usr -no-integrated-as -Werror=unknown-warning-option -Wno-misleading-indentation -Wno-bool-operation -fno-PIE -mno-implicit-float -DCONFIG_AS_LSE=1 -DCONFIG_VDSO32=1 -fno-asynchronous-unwind-tables -fno-pic -Wno-asm-operand-widths -fno-delete-null-pointer-checks -Wno-int-in-bool-context -Wno-address-of-packed-member -O2 --param=allow-store-data-races=0 -DCC_HAVE_ASM_GOTO -Wframe-larger-than=2048 -fstack-protector-strong -Wno-format-invalid-specifier -Wno-gnu -Wno-duplicate-decl-specifier -Wno-pointer-bool-conversion -Wno-self-assign -Wno-tautological-compare -mno-global-merge -Wno-unused-const-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -Wdeclaration-after-statement -Wno-pointer-sign -Wno-array-bounds -fno-strict-overflow -fno-merge-all-constants -fmerge-constants -fno-stack-check -Werror=implicit-int -Werror=strict-prototypes -Werror=date-time -Werror=incompatible-pointer-types -fmacro-prefix-map=../= -Wno-initializer-overrides -Wno-unused-value -Wno-format -Wno-sign-compare -Wno-format-zero-length -Wno-uninitialized  -I/kernel/msm-4.9/techpack/audio/include  -I/kernel/msm-4.9/techpack/audio/include/uapi -Wheader-guard   -DVENDOR_EDIT -DKBUILD_BASENAME='"apr_tal_glink"'  -DKBUILD_MODNAME='"apr_dlkm"' -c -o techpack/audio/ipc/.tmp_apr_tal_glink.o ../techpack/audio/ipc/apr_tal_glink.c

source_techpack/audio/ipc/apr_tal_glink.o := ../techpack/audio/ipc/apr_tal_glink.c

deps_techpack/audio/ipc/apr_tal_glink.o := \
...
techpack/audio/ipc/apr_tal_glink.o: $(deps_techpack/audio/ipc/apr_tal_glink.o)
